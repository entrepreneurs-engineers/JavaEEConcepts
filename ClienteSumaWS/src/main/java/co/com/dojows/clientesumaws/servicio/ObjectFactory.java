...
package co.com.dojows.clientesumaws.servicio;
 ...
 * generated in the co.com.dojows.clientesumaws.servicio package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sumar_QNAME = new QName("http://beans.sumaws.dojows.com.co/", "sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://beans.sumaws.dojows.com.co/", "sumarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.com.dojows.clientesumaws.servicio
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://beans.sumaws.dojows.com.co/", name = "sumar")
     ...
     */
    @XmlElementDecl(namespace = "http://beans.sumaws.dojows.com.co/", name = "sumarResponse")
