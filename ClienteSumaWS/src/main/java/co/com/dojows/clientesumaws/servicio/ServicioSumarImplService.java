 ...
 * 
 */
@WebServiceClient(name = "ServicioSumarImplService", targetNamespace = "http://beans.sumaws.dojows.com.co/", wsdlLocation = "http://localhost:8080/ServicioSumarImplService/ServicioSumarImpl?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOSUMARIMPLSERVICE_QNAME = new QName("http://beans.sumaws.dojows.com.co/", "ServicioSumarImplService");
    ...
    public ServicioSumarWS getServicioSumarImplPort() {
        return super.getPort(new QName("http://beans.sumaws.dojows.com.co/", "ServicioSumarImplPort"), ServicioSumarWS.class);
    }
    ...
    public ServicioSumarWS getServicioSumarImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://beans.sumaws.dojows.com.co/", "ServicioSumarImplPort"), ServicioSumarWS.class, features);
    }
